...
object Exceptions extends App {
  ...
  //throwable classes extend the Throwable classes
  ...
  try {
    ...
    println("Final output of my code")

    //how to define our new exception
    ...
    /*
      ...
      3. PocketCalculator
        ...
        Throw
             OverflowException if add(x,y) exceends Int.MAX_VALUE
             UnderflowException if substract(x,y) exceeds Int.MIN_VALUE
             MathCalculationException for division by o
